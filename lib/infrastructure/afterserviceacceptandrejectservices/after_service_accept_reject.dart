...
class AfterServiceAcceptReject implements AfterAcceptRejectRepo {
  ...
  @override
  Future<Either<MainFailurs, AfteAcceptServices>> accept({required String id}) async{
  ...
  @override
  Future<Either<MainFailurs, AfteAcceptServices>> reject({required String id}) async{
